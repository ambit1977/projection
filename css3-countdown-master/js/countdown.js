...
function CDT(){
 ...
 // Set countdown limit
// var tl = new Date('2023/10/31 00:00:00');
// var tl = new Date('2024/10/31 00:00:00');
// var tl = new Date('2024/12/25 00:00:00');
// var tl = new Date('2025/10/31 00:00:00');
 var tl = new Date('2025/12/25 00:00:00');

 // You can add time's up message here
 var timer = new CountdownTimer('CDT',tl,'<span class="number-wrapper"><div class="line"></div><span class="number end">Happy halloween!</span></span>');
 timer.countDown();
}
